        ...
        for (var i = 0; i < this.props.stages.length; i++) {
            if (i < this.state.currentStage) {
                ...
                <div key={i} className="mdl-stepper-step step-done">
                    ...
                    <div className="mdl-stepper-title">{this.props.stages[i].title}</div>
                    {this.props.stages[i].optional ? <div className="mdl-stepper-optional">{this.props.stages[i].optional}</div> : ""}
